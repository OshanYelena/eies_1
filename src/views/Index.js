...
export default function Index() {
  return (
    <>
      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full inline-flex items-center justify-center text-center md:w-6/12 ">
                  ...
                  <div className="relative flex flex-col ">
                    <div className=" flex-auto">
                      ...
                      <p className="mb-4 text-center  text-blueGray-500">
                        Welcome to the Electrical and Information Engineering
                        Society (EIES) of the Department of Electrical and
                        Information Engineering. Although the department has
                        many societies, this is the main forum accustomed to
                        upgrading student’s life in the department by allowing
                        them to improve not only academic and technical skills
                        but also their leadership interpersonal and professional
                        qualities. It has the responsibility of organizing
                        workshops in collaboration with Alumni Association of
                        Ruhuna Electrical and Information Engineering (AAREIE)
                        and conducting annual calendar events such as XbotiX
                        robotics competition, HackDoze, Career Fair, etc. This
                        website provides an overview of student activities
                        inherent to EIES.
                      </p>
                    </div>
                  </div>
      ...
      <section className="block relative z-1 bg-yellow-500">
        <div className="container mx-auto">
                  ...
                  <Link to="/">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        ...
                        src={
                          require("assets/img/67548211_2188161624807106_5474347418352877568_n.jpeg")
                            .default
                        }
                      />
                    </div>
                  ...
                  <Link to="/">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        ...
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src={
                          require("assets/img/81468739_2304218053201462_4629050236197666816_n.jpg")
                            .default
                        }
                      />
                    </div>
                  ...
                  <Link to="/">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        ...
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src={
                          require("assets/img/78178827_1304585176394320_1276145469243785216_n (1).jpg")
                            .default
                        }
                      />
                    </div>
                  ...
                  <Link to="/">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        ...
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src={
                          require("assets/img/83846224_1353769164809254_5427826686244683776_n.jpg")
                            .default
                        }
                      />
                    </div>
